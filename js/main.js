...
const projects = [
  {
    ...
    description: 'AI-powered learning tracker that turns messy study sessions into a clear weekly plan.',
    status: 'available',
  ...
  },
  {
    ...
    description: 'A lightweight workspace for drafting, versioning, and testing LLM prompts.',
    status: 'available',
    tags: ['JavaScript', 'API',],
